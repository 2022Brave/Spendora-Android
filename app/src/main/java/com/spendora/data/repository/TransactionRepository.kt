...
class TransactionRepository(
    ...
    fun getCycleSummary(cycle: FinancialCycle): Flow<FinancialCycleSummary> {
        ...
        return combine(
            ...
            val expense = args[0] as Double
            val income = args[1] as Double
            val refunds = args[2] as Double
            val transfers = args[3] as Double
            val cash = args[4] as Double
    ...
    fun getCategorySpendingForCycle(cycle: FinancialCycle): Flow<List<com.spendora.data.dao.CategorySpendingSummary>> {
        return transactionDao.getCategorySpendingSummaryBetween(cycle.startTimestamp, cycle.endTimestamp)
    }
    ...
    fun getDashboardSummary(
        ...
        return combine(
            ...
            val exp = args[0] as Double
            val inc = args[1] as Double
            val ref = args[2] as Double
            val trf = args[3] as Double
            val csh = args[4] as Double
            val count = args[5] as Int
            val pending = args[6] as Int
            @Suppress("UNCHECKED_CAST")
            val budgets = args[7] as List<com.spendora.data.entity.BudgetEntity>
